...
export default function Home() {
  return (
    <div className="bg-slate-50">
      ...
      <section>
        <MaxWidthWrapper className="mb-12 px-6 lg:px-8">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              <Check className="h-5 w-50 text-green-600 inline mr-1.5" />
            ...
            <li className="w-fit">
              <Check className="h-5 w-50 text-green-600 inline mr-1.5" />5 year
              print warranty
            </li>
            ...
            <div className="flex justify-center">
              ...
              >
                Create your case now <ArrowRight className="h-4 w-4 m1-1.5" />
              </Link>
            </div>
          </ul>
        </MaxWidthWrapper>
